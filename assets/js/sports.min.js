          ...
          $scope.leagues = [
            ...
            
            {
            ...
            },
             {
              ...
              leagueName: "Saudi-Arabian Pro League",
              idLeague: "4668",
              season: "2023-2024",
            },
             {
            ...
            },
            {
            ...
            
             {
              ...
              leagueName: "European League of Football",
              idLeague: "5063",
              season: "2023",
            },
             {
            ...
            },
            {
            ...
            },
             {
              ...
              leagueName: "UEFA European Championships",
              idLeague: "4502",
              season: "2023-2024",
            },
          ];
          ...
          $scope.loadTeamLogos = function () {
            ...
            $http
              ...
              .then(function (response) {
                ...
                $scope.noImage = "https://sportxyou.github.io/assets/img/noimage-available.png"
                ...
                $scope.events.forEach(function (event) {
                  ...
                  if (homeTeam) {
                    ...
                    event.strTeamHomeFanart1 = homeTeam.strTeamFanart1 && (homeTeam.strTeamFanart1 + "/preview") || $scope.noImage;
                    event.strTeamHomeFanart2 = homeTeam.strTeamFanart2 && (homeTeam.strTeamFanart2 + "/preview") || $scope.noImage;
                    event.strTeamHomeFanart3 = homeTeam.strTeamFanart3 && (homeTeam.strTeamFanart3 + "/preview") || $scope.noImage;
                    event.strTeamHomeFanart4 = homeTeam.strTeamFanart4 && (homeTeam.strTeamFanart4 + "/preview") || $scope.noImage;
                    event.strTeamHomeBanner = homeTeam.strTeamBanner  && (homeTeam.strTeamBanner + "/preview") || $scope.noImage;
                    event.jerseyHome = homeTeam.strTeamJersey && (homeTeam.strTeamJersey + "/preview") || $scope.logoUrl;
                    event.stadiumHome = homeTeam.strStadiumThumb && (homeTeam.strStadiumThumb + "/preview") || $scope.noImage;
                    ...
                    event.homeTeamLogo = $scope.logoUrl;
                    event.jerseyHome = $scope.$scope.noImage;
                    event.strTeamHomeFanart1 = $scope.noImage;
                    event.strTeamHomeFanart2 = $scope.noImage;
                    event.strTeamHomeFanart3 = $scope.noImage;
                    event.strTeamHomeFanart4 = $scope.noImage;
                    event.strTeamHomeBanner = $scope.noImage;
                    event.stadiumHome = $scope.noImage;
                  }
                  ...
                  if (awayTeam) {
                    ...
                    event.strTeamAwayFanart1 = awayTeam.strTeamFanart1 && (awayTeam.strTeamFanart1 + "/preview") || $scope.noImage;
                    event.strTeamAwayFanart2 = awayTeam.strTeamFanart2 && (awayTeam.strTeamFanart2 + "/preview") || $scope.noImage;
                    event.strTeamAwayFanart3 = awayTeam.strTeamFanart3 && (awayTeam.strTeamFanart3 + "/preview") || $scope.noImage;
                    event.strTeamAwayFanart4 = awayTeam.strTeamFanart4 && (awayTeam.strTeamFanart4 + "/preview") || $scope.noImage;
                    event.strTeamAwayBanner = awayTeam.strTeamBanner  && (awayTeam.strTeamBanner + "/preview") || $scope.noImage;
                    event.jerseyAway = awayTeam.strTeamJersey && (awayTeam.strTeamJersey + "/preview") || $scope.logoUrl;
                    event.stadiumAway = awayTeam.strStadiumThumb && (awayTeam.strStadiumThumb + "/preview") || $scope.noImage;
                    ...
                    event.awayTeamLogo = $scope.logoUrl;
                    event.jerseyAway = $scope.logoUrl;
                    event.strTeamAwayFanart1 = $scope.noImage;
                    event.strTeamAwayFanart2 = $scope.noImage;
                    event.strTeamAwayFanart3 = $scope.noImage;
                    event.strTeamAwayFanart4 = $scope.noImage;
                    event.strTeamAwayBanner = $scope.noImage;
                    event.stadiumAway = $scope.noImage;
                  }
                });
              })
